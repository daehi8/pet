...
<b>글쓰기</b>
<br>
<form method="post" enctype="multipart/form-data" name="writeform" action="/pet/board/writePro.do" onsubmit="return writeSave()">
...
<tr>
	<td colspan=2 align="center">
	 ...
	 <input class="btn btn-dark"  type="button" value="목록" OnClick="window.location='/pet/board/list.do'">
</td></tr></table>
</form>
</div>
</div>
