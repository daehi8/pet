  ...
  <body>
	...
	<!-- 네비게이션 바 -->
 	...
 	<nav class="navbar navbar-expand-lg navbar-dark	bg-dark">
  	...
  	<a class="navbar-brand" href="/pet/doctor/main.do">모두닥 for doctors</a>
  	

  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
     <li class="nav-item">
        <a class="nav-link" href="/pet/member/main.do">모두닥</a>
      </li>
    ...
    <div class="dropdown-menu">   
      <a class="dropdown-item" href="/pet/doctor/modify.do">나의 정보</a>
